      ...
      <div className="flex gap-2 mb-4">
        <button
          ...
          className={`px-3 py-1 rounded ${
            filtro === "todos" ? "bg-linear-to-tr from-[#c7ccd2] to-[#a7aeb6] text-[#0f1115]"
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            filtro === "activos" ? "bg-linear-to-tr from-[#c7ccd2] to-[#a7aeb6] text-[#0f1115]"
                  : "bg-[#23272b] text-[#c7cdd4] hover:bg-[#3a3f45]"
          }`}
        >
          Activos
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            filtro === "inactivos" ? "bg-linear-to-tr from-[#c7ccd2] to-[#a7aeb6] text-[#0f1115]"
                  : "bg-[#23272b] text-[#c7cdd4] hover:bg-[#3a3f45]"
          }`}
        >
          Inactivos
