              ...
              >
                ...
                <td className="border-b border-[#3a3f45] p-3 text-center">
                  <button
                    ...
                    className="px-4 py-2 rounded-md font-semibold transition duration-200 bg-linear-to-tr from-[#c7ccd2] to-[#a7aeb6] text-[#0f1115] hover:from-[#d5d9de] hover:to-[#b3bbc3] active:scale-95"
                  >
                    Crear Cuenta
                  </button>
                </td>
